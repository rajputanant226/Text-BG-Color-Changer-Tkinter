...
✔ Event-driven functionality using button clicks
...
Using Label and Button widgets

Styling widgets (font, color, layout)

Handling events using command=

Updating UI dynamically using config()

Layout management with pack() / grid()
